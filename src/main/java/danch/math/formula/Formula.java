...
public abstract class Formula implements Cloneable {
	public abstract double evaluate(BiFunction<Character, Integer, Double> variableBinder);
	...
	public abstract void bindVariablesAsConstants(char series, BiFunction<Character, Integer, Double> variableBinder);
